...
- 이어서 시작 화면 전용 문자열 `4`건도 [startup_intro_texts.json](/Users/user/test/analysis/startup_intro_texts.json) 으로 분리했고, 부족한 `8`글자를 보충한 뒤 `/Users/user/test/patched_roms/rebuild_check/hnr_startup_intro_test.gba` 기준 `4 in_place` 까지 확인했다
