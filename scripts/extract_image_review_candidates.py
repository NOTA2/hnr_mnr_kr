...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "dialogue_window_frame_art",
            "portrait_headshot_assets",
            "ui_panel_label_art",
...
UNIT_CONFIG = {
    ...
    "dialogue_window_frame_art": {
        "workspace": "04_dialogue_window_frame_art",
        "report_stem": "dialogue_window_frame_candidate_report",
        "title": "대사창 프레임/판넬 후보 덤프",
        "min_size": 0x0800,
        "max_size": 0x8000,
    },
    "portrait_headshot_assets": {
        "workspace": "05_portrait_headshot_assets",
        "report_stem": "portrait_headshot_candidate_report",
        "title": "초상화/헤드샷 후보 덤프",
        "min_size": 0x0800,
        "max_size": 0x10000,
    },
