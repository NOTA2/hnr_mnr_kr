        ...
        "families": [
            ...
            },
            {
                ...
                "rules": {
                    ...
                    "packed_relocation_supported": True,
                },
                "runtime_candidate_family": "shared_text_object_r3_20",
                "observed_runtime_profile": {
                ...
                "notes": [
                    ...
                    "The current build pipeline can repack each Registry D entry to expanded ROM space and update the Registry D pointer-length table.",
                    "Translations may exceed the original in-place payload length; prioritize natural meaning, then fix visual overflow with line/page QA.",
            ...
            },
            {
                ...
                "notes": [
                    ...
                    "Runtime window family is still unresolved and this family does not yet have packed bank relocation, so use the expansion audit: keep fixed/exact records within byte limits, use available slack for clearer terms, and avoid inserting manual line breaks.",
                ],
                "samples": [
                    {
                        "offset": "0x08AEFC",
            ...
            },
            {
                ...
                "rules": {
                    ...
                    "preserve_ideographic_padding": False,
                    "korean_separator_normalization": "strip_padding_keep_0x0b",
                    "allow_manual_newline": False,
                },
                "notes": [
                    "Representative sources are battle_texts.json, ability_texts.json, and material_texts.json.",
                    "Some records are short names only, while many description records use ideographic-space padding plus an inline 0x0B split in the Japanese source.",
                    "The structure is objective even though the runtime battle/menu box family remains unresolved.",
                    "Korean tooling restores the fixed-width name-field padding before the runtime 0x0B separator; replacing 0x0B with a normal newline can hide the description in alchemy info panels.",
                ],
                "samples": [
                    {
                        "offset": "0x3D203D",
